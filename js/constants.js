...
const TEMPLATE_KINDS = {
  rab: {
    ...
    adminSubtitle: 'Buat kategori folder lalu unggah file PDF/Excel di dalamnya',
    userTitle: 'Unduh Template RAB',
    userSubtitle: 'Pilih folder kategori, lalu unduh file PDF/Excel. Isi RAB di luar aplikasi.',
